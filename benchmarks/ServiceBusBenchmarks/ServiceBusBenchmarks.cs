...
public class ServiceBusBenchmarks
{
    ...
    public static async Task Main(String[] args)
    {
        ...
        ServiceBusBenchmarks ServiceBusBenchmarks = new ServiceBusBenchmarks();
        ...
        {
            case 1:
                await ServiceBusBenchmarks.TimeFromSendToProcessed<OneSubEvent, OneSubEventProcessor>(
                ...
                break;
            case 2:
                await ServiceBusBenchmarks.TimeFromSendToProcessed<TwoSubEvent, TwoSubEventProcessor>(
                ...
                break;
            case 4:
                await ServiceBusBenchmarks.TimeFromSendToProcessed<FourSubEvent, FourSubEventProcessor>(
                ...
                break;
            case 8:
                await ServiceBusBenchmarks.TimeFromSendToProcessed<EightSubEvent, EightSubEventProcessor>(
                ...
                break;
            case 16:
                await ServiceBusBenchmarks.TimeFromSendToProcessed<SixteenSubEvent, SixteenSubEventProcessor>(
